...
func (in *CEosLabDeviceSpec) DeepCopyInto(out *CEosLabDeviceSpec) {
	*out = *in
	...
	if in.WaitForAgents != nil {
		in, out := &in.WaitForAgents, &out.WaitForAgents
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *CEosLabDeviceStatus) DeepCopyInto(out *CEosLabDeviceStatus) {
	*out = *in
	...
	in.PodConfigMapStatus.DeepCopyInto(&out.PodConfigMapStatus)
}
...
func (in *ConfigMapStatus) DeepCopyInto(out *ConfigMapStatus) {
	*out = *in
	if in.SelfSignedCertStatus != nil {
		in, out := &in.SelfSignedCertStatus, &out.SelfSignedCertStatus
		*out = make(map[string]SelfSignedCertConfig, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.IntfMappingStatus != nil {
		in, out := &in.IntfMappingStatus, &out.IntfMappingStatus
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ToggleOverridesStatus != nil {
		in, out := &in.ToggleOverridesStatus, &out.ToggleOverridesStatus
		*out = make(map[string]bool, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.StartupConfigResourceVersion != nil {
		in, out := &in.StartupConfigResourceVersion, &out.StartupConfigResourceVersion
		*out = new(string)
		**out = **in
	}
}
